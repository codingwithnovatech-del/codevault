...
import { callGroq, AI_PROMPTS } from '../lib/ai';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-on-surface-variant/70">Powered by Groq Llama 3.1 — fast & free AI for every developer</p>
      </div>
      ...
      <p className="text-[10px] font-mono text-on-surface-variant/20 text-center">
        Responses are generated by Groq Llama 3.1. Verify important code before use. Limited to 20 calls/minute.
      </p>
    </div>
  );
}
